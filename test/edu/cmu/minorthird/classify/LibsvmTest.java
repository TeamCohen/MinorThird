...
public class LibsvmTest extends AbstractClassificationChecks{
	...
	public void testWrapper(){
		try{
			...
			Dataset trainData=
					DatasetLoader.loadSVMStyle(new File(new URI(url.toExternalForm())));
			...
			double[] expect=
					new double[]{0.13769470404984424,0.6011745705024105,
							0.6934812760055479,1.3132616875183545};
	...
	public void testMultiClassClassification(){
		...
		try{
			...
			MultiClassSVMClassifier c1=
					(MultiClassSVMClassifier)(new DatasetClassifierTeacher(trainSet)
							.train(l));
