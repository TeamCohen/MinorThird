...
public class MixupProgramTest extends TestSuite 
{
    ...
    public static class NestedProgramTest3 extends AbstractProgramTest
    {
        ...
        public void doTest() throws Mixup.ParseException {
            EncapsulatingAnnotatorLoader eal = 
                new EncapsulatingAnnotatorLoader(false,
    ...
    {
        public MultiLevelTest() { super("doTest"); }
        public void doTest() throws Mixup.ParseException {
            String testCaseDir="edu/cmu/minorthird/text/mixup/testcases";
            ...
            // Pseudotokens
            String pseudotokenProgDef = "defLevel newLevel = pseudotoken extracted_date;\n";
            pseudotokenProgDef += "onLevel newLevel;\n";
            pseudotokenProgDef += "importFromLevel root extracted_date = extracted_date;\n";
            ...
            assertEquals( " Professor Warren Baker from the Department of Chemistry at\nQueen\'s University, Kingston, Canada, will conduct the seminar", tokens[4].getValue() );
            assertEquals( "\n", tokens[5].getValue() );
