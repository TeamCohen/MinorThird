...
public class LongTestPackage extends TestSuite
{
  ...
  public LongTestPackage(String name) { super(name); }
...
/*
		suite.addTest( new UITest(TrainTestExtractor.class,
															new String[]{
																...
																"-test","cspace.09",
																"-spanType","true_name",
																"-learner", "new SequenceAnnotatorLearner(new CollinsPerceptronLearner(1,20), new Recommended.TokenFE(), new BeginContinueEndUniqueReduction())"}) {
				public void checkResult(Object result) {
		...
		suite.addTest( new UITest(TrainTestExtractor.class,
															new String[]{
																...
																"-test","cspace.09",
																"-spanType","true_name",
																"-learner", "new SequenceAnnotatorLearner(new CRFLearner(1,20), new Recommended.TokenFE(), new BeginContinueEndUniqueReduction())"}) {
				public void checkResult(Object result) {
					ExtractionEvaluation e = (ExtractionEvaluation)result;
