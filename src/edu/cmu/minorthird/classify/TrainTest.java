...
public class TrainTest
{
	...
	ClassifyCommandLineUtil.SimpleTrainTestParams.class, ClassifyCommandLineUtil.MultiTrainTestParams.class, 
	ClassifyCommandLineUtil.SeqTrainTestParams.class, //ClassifyCommandLineUtil.TrainTestParams.class,
	...
	public String getTrainTestParamsHelp() { return "Define what type of experiment you would like to run: <br>" +
	    ...
	    //public void type(String s) {type=s;}
            public void gui() { 
		useGUI=true; 
		if(trainTestParams.type != null)
		    trainTestParams = trainTestParams.type;
		else trainTestParams = new ClassifyCommandLineUtil.SimpleTrainTestParams();
	    }
            public void usage() {
                        ...
                        public JComponent componentFor(Object o)
                        {
                            ...
                            JButton showLabelsButton = new JButton(new AbstractAction("Show train data") {
                                public void actionPerformed(ActionEvent ev) {
                                    new ViewerFrame("Labeled TextBase", new SmartVanillaViewer(trainTestParams.getTrainData()));
                                }
                            });
