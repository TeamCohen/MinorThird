...
public class Statement implements Serializable
{
    ...
    public static int REGEX=1, MIXUP=2, FILTER=3, PROVIDE=4, REQUIRE=5, DECLARE=6, TRIE=7, ANNOTATE_WITH=8;
     ...
     */
    public ArrayList getFilesToLoad() { return filesToLoad; }
     ...
     */
    public Set getWordSet() { return wordSet; }
     ...
     */
    public String getImportLevel() { return importLevel; }
     ...
     */
    public Mixup getMixupExpr() { return mixupExpr; }

    /**
     * Returns the phrase list for when this statement will define a trie.
     */
    public ArrayList getPhraseList() { return phraseList; }
