...
public class BasicTextEnv implements MutableTextEnv, Serializable
{
  ...
  // don't serialize this
	...
	public BasicTextEnv() { this.textBase = null; }
	public BasicTextEnv(TextBase textBase) { this.textBase = textBase; }
	...
	/** A convenience method which creates an empty enviroment
	 * containing a single string.
	 */
	public BasicTextEnv(String s) {
	...
	public String toString() {
		return "[BasicEnv "+typeDocumentSetMap+"]";
	}
