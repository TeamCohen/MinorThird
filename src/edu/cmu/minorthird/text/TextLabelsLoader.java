...
public class TextLabelsLoader
{
    ...
    public void saveDocsWithEmbeddedTypes( TextLabels labels, File dir ) throws IOException {
        ...
        while (looper.hasNext()) {
            ...
            out = new PrintStream( new FileOutputStream(new File(dir + "/" + currDoc.getDocumentId())));
     ...
     * IllegalArgumentException is thrown because a well-formed
     * XML document cannot be created.
     */
    public String createXMLmarkup(String documentId,TextLabels labels) {
        ...
        ArrayList sortedLabels = new ArrayList(unsortedLabels.size());
        ...
        ArrayList sortedTags = new ArrayList(sortedLabels.size() * 2);
    ...
    private class TagInfo {
        ...
        public TagInfo(int pos, String tag, boolean isOpenTag) {
            this.pos=pos; this.tag=tag; this.isOpenTag=isOpenTag;
        }
    }
