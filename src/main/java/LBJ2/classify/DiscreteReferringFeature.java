...
public class DiscreteReferringFeature extends DiscreteReferrer
{
   ...
   **/
  public DiscreteReferringFeature(Classifier c, ByteString i,
                                  DiscreteFeature r) {
   ...
   **/
  public DiscreteReferringFeature(String p, String c, ByteString i,
  ...
  public Feature encode(String e) {
    ...
    return
      new DiscreteReferringFeature(
            containingPackage, generatingClassifier, identifier, newReferent,
            valueIndex, totalValues);
  }


  /**
    * The hash code of a <code>DiscreteReferringFeature</code> is the sum of
  ...
  /**
    * Two <code>DiscreteReferringFeature</code>s are equivalent when their
  ...
  public boolean classEquivalent(Feature f) {
    return f instanceof DiscreteReferringStringFeature;
  }
  ...
  public int compareNameStrings(Object o) {
    ...
    if (d != 0) return d;
    return identifier.compareTo(((DiscreteReferringFeature) o).identifier);
  }
