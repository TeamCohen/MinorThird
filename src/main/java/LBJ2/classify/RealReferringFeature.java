...
/**
  ...
  * @author Nick Rizzolo
 **/
public class RealReferringFeature extends RealReferrer
{
  /**
   ...
   **/
  protected RealReferringFeature() { }

  /**
    * Sets both the identifier and the referent.
    *
    * @param c  The classifier that produced this feature.
    * @param i  The new <code>RealReferringFeature</code>'s identifier.
    * @param r  The real feature referred to by this new feature.
   **/
  public RealReferringFeature(Classifier c, ByteString i, RealFeature r) {
  ...
  /**
    ...
    * @param r  The real feature referred to by this new feature.
   **/
  public RealReferringFeature(String p, String c, ByteString i, RealFeature r)
  {
    super(p, c, r);
    identifier = i;
  }
  ...
  public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
    ...
    return
      new RealReferringFeature(containingPackage, generatingClassifier,
                               identifier, f);
  }
  ...
  public RealFeature multiply(double m) {
    return
      new RealReferringFeature(containingPackage, generatingClassifier,
                               identifier, referent.multiply(m));
  }
  ...
  public Feature encode(String e) {
    ...
    if (newReferent == referent) return this;
    return
      new RealReferringFeature(containingPackage, generatingClassifier,
                               identifier, newReferent);
  }


  /**
    * The hash code of a <code>RealReferringFeature</code> is the sum of the
  ...
  /**
    * Two <code>RealReferringFeature</code>s are equivalent when their
  ...
  public boolean equals(Object o) {
    return
      super.equals(o)
      && (o instanceof RealReferringFeature
  ...
  public boolean classEquivalent(Feature f) {
    return f instanceof RealReferringStringFeature;
  }
  ...
  public int compareNameStrings(Object o) {
    ...
    if (d != 0) return d;
    return identifier.compareTo(((RealReferringFeature) o).identifier);
  }
