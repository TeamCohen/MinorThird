...
public class DiscreteArrayFeature extends DiscretePrimitiveFeature
{
   ...
   **/
  public DiscreteArrayFeature(String p, String c, ByteString id, ByteString v,
                              int i, int l) {
  ...
  public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
    if (totalValues() == 2)
      return
        new DiscreteArrayFeature(
              containingPackage, generatingClassifier, identifier,
              ByteString.emptyString, (short) -1, (short) 2, getArrayIndex(),
              0);
    return this;
  }
    ...
    if (totalValues == 2)
      return
        new RealArrayFeature(containingPackage, generatingClassifier,
                             identifier, valueIndex, arrayIndex, arrayLength);
    else {
      ...
      id.append(toAppend);
      return
        new RealArrayFeature(containingPackage, generatingClassifier, id, 1,
  ...
  public boolean equals(Object o) {
    return
      super.equals(o)
      && (o instanceof DiscreteArrayFeature
  ...
  public boolean classEquivalent(Feature f) {
    return f instanceof DiscreteArrayStringFeature;
  }
