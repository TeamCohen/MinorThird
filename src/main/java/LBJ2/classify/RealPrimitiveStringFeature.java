...
/**
  ...
  * @author Nick Rizzolo
 **/
public class RealPrimitiveStringFeature extends RealFeature
{
  /**
  ...
  /**
    ...
    * @param i  The new <code>RealPrimitiveStringFeature</code>'s identifier.
    * @param v  The new <code>RealPrimitiveStringFeature</code>'s value.
   **/
  public RealPrimitiveStringFeature(String p, String c, String i, double v) {
    super(p, c);
    identifier = i;
    value = v;
  }
  ...
  public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
    return
      new RealPrimitiveStringFeature(containingPackage, generatingClassifier,
                                     identifier, 0);
  }
  ...
  /**
    * The hash code of a <code>RealPrimitiveStringFeature</code> is the sum of the
  ...
  /**
    * Two <code>RealPrimitiveStringFeature</code>s are equivalent when their
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RealPrimitiveStringFeature) {
    ...
    return f.identifier.equals(identifier) && value == f.value;
  }
  ...
  public boolean classEquivalent(Feature f) {
    return f instanceof RealPrimitiveFeature;
  }
