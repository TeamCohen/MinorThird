...
/**
  ...
  * @author Nick Rizzolo
 **/
public class RealArrayStringFeature extends RealPrimitiveStringFeature
{
   ...
   **/
  protected RealArrayStringFeature() { }
   ...
   **/
  public RealArrayStringFeature(String p, String c, String id, double v,
                                int i, int l) {
    super(p, c, id, v);
    arrayIndex = i;
    arrayLength = l;
  ...
  public Feature getFeatureKey(Lexicon lexicon, boolean training, int label) {
   return
     new RealArrayStringFeature(
           containingPackage, generatingClassifier, identifier, 0, arrayIndex,
           0);
  }
  ...
  public RealFeature multiply(double m) {
    return
      new RealArrayStringFeature(
            containingPackage, generatingClassifier, identifier, value * m,
  ...
  public Feature withStrength(double s) {
    return
      new RealArrayStringFeature(
            containingPackage, generatingClassifier, identifier, s,
            arrayIndex, arrayLength);
  }
  ...
  public Feature encode(String e) {
    ...
    return
      new RealArrayFeature(containingPackage, generatingClassifier, id, value,
                           arrayIndex, arrayLength);
  }


  /**
    * The hash code of a <code>RealArrayStringFeature</code> is the sum of the
  ...
  /**
    * Two <code>RealArrayStringFeature</code>s are equivalent when their
  ...
  public boolean equals(Object o) {
    return
      super.equals(o)
      && (o instanceof RealArrayStringFeature
  ...
  public boolean classEquivalent(Feature f) {
    return f instanceof RealArrayFeature;
  }
  ...
  public int compareTo(Object o) {
    ...
    if (d != 0) return d;
    RealArrayStringFeature f = (RealArrayStringFeature) o;
