...
{
  /** Default constructor. */
  public SwitchGroupList() { super(-1, -1, " "); }

  /**
    * Initializing constructor.  Requires its argument to be
    * non-<code>null</code>.
    *
    * @param s  A single <code>SwitchGroup</code> with which to initialize
    *           this list.
   **/
  ...
  /**
    * Adds another <code>SwitchGroup</code> to the end of the list.
    *
    * @param s  A reference to the <code>SwitchGroup</code> to be added.
   **/
  public void add(SwitchGroup s) { list.add(s); }


  /**
    * Adds all the <code>SwitchGroup</code>s in another
    * <code>SwitchGroupList</code> to the end of this
    * <code>SwitchGroupList</code>.
    *
    * @param s  The list to be added.
   **/
  public void addAll(SwitchGroupList s) { list.addAll(s.list); }
  ...
  public SwitchGroup[] toArray() {
    return (SwitchGroup[]) list.toArray(new SwitchGroup[list.size()]);
  }
  ...
  public SwitchGroupListIterator listIterator() {
    return new SwitchGroupListIterator();
  }
   ...
   **/
  public Object clone() {
    SwitchGroupList clone = new SwitchGroupList();
    for (Iterator i = list.iterator(); i.hasNext(); )
      clone.list.add(((SwitchGroup) i.next()).clone());
    return clone;
  }
  ...
  /**
    ...
    * @author Nick Rizzolo
   **/
  public class SwitchGroupListIterator extends NodeListIterator
  {
    /**
     ...
     **/
    public SwitchGroup nextItem() { return (SwitchGroup) I.next(); }
     ...
     **/
    public SwitchGroup previousItem() { return (SwitchGroup) I.previous(); }
  }
}
