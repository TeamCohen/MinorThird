...
/**
  ...
  * <code>Collection</code>, and the universal quantifier expression is
  * sastisfied iff <code><i>constraint-expression</i></code> is satisfied for
  * all settings of <code><i>argument</i></code> taken from the
  * <code>Collection</code>.
  *
  * @author Nick Rizzolo
 **/
public class UniversalQuantifierExpression
       extends QuantifiedConstraintExpression
{
   ...
   **/
  public UniversalQuantifierExpression(int line, int byteOffset, Argument a,
  ...
  /**
    ...
    * @param co The quantified constraint.
   **/
  public UniversalQuantifierExpression(TokenValue t, Argument a,
                                       Expression c, ConstraintExpression co)
  {
  ...
  public Object clone() {
    return
      new UniversalQuantifierExpression(
