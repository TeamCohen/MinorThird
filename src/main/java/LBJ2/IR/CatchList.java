...
{
  /** Default constructor. */
  public CatchList() { super(-1, -1, " "); }

  /**
    * Initializing constructor.  Requires its argument to be
    * non-<code>null</code>.
    *
    * @param s  A single <code>CatchClause</code> with which to initialize
    *           this list.
   **/
   ...
   **/
  public void add(CatchClause s) { list.add(s); }


  /**
    * Adds all the <code>CatchClause</code>s in another
    * <code>CatchList</code> to the end of this
    * <code>CatchList</code>.
    *
    * @param s  The list to be added.
   **/
  public void addAll(CatchList s) { list.addAll(s.list); }
  ...
  /**
    ...
    *         list.
   **/
  public CatchListIterator listIterator() { return new CatchListIterator(); }
  ...
  public class CatchListIterator extends NodeListIterator
  {
     ...
     **/
    public CatchClause nextItem() { return (CatchClause) I.next(); }
     ...
     **/
    public CatchClause previousItem() { return (CatchClause) I.previous(); }
  }
}
