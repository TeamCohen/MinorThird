...
public class TrainTest{
	...
	private static final Class<?>[] SELECTABLE_TYPES=
			new Class[]{
					...
					ClassifyCommandLineUtil.SimpleTrainTestParams.class,
					ClassifyCommandLineUtil.MultiTrainTestParams.class,
...
//			new HashSet(Arrays.asList(new String[]{"train","test","trainTest"}));
	...
	public static class DataClassificationTask implements
		...
		public String getTrainTestParamsHelp(){
		...
		protected class GUIParams extends BasicCommandLineProcessor{
			...
			public void gui(){
				useGUI=true;
				if(ClassifyCommandLineUtil.TrainTestParams.type!=null)
					trainTestParams=ClassifyCommandLineUtil.TrainTestParams.type;
				else
							...
							JButton showLabelsButton=
									new JButton(new AbstractAction("Show train data"){
										...
										public void actionPerformed(ActionEvent ev){
											new ViewerFrame(
													"Labeled TextBase",
													new SmartVanillaViewer(trainTestParams.getTrainData()));
										}
									});
